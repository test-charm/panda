// Real: board/drivers/led.h — de-stubbed for e2e
// Depends on: pwm_init/pwm_set (from pwm.h), current_board (from board_declarations.h),
//             set_gpio_* (from gpio.h), TIM3 (from board.h #define), GPIO_AF2_TIM3 (from fake_stm.h)
