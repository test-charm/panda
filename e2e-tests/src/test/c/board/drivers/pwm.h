// Real: board/drivers/pwm.h — de-stubbed for e2e
// register_set / register_set_bits from board/drivers/registers.h (included via stm32h7_config.h)
// TIM_TypeDef with full fields from fake_stm.h
