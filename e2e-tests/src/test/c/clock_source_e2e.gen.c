// Hand-maintained verbatim copy of clock_source_set_timer_params() from board/drivers/clock_source.h.
// Previously auto-generated; now maintained directly since library reload handles state isolation.
